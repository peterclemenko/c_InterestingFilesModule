...
* PATH_KEYWORD: Search folder names for this string.
...
the file "ajpg". 
* NAME: Search the file names for this string.  It must be an exact 
length match. For example, the string "bomb" will not match "abomb". 
...
The behavior is undefined in the current version if you specify more
than one search criteria at a time. 
